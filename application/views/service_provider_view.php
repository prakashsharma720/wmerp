...
<a href="javascript:void(0);" class="btn btn-icon avatar-text avatar-md" data-bs-toggle="collapse" data-bs-target="#filterFormWrapper" title="Filter">
      ...
      <a href="<?php echo base_url(); ?>index.php/Service_providers/add" class="btn btn-icon avatar-text avatar-md" data-toggle="tooltip" title="New service_provider"><i class="feather feather-plus"></i></a>
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered table-striped" id="proposalList">
                ...
                <tbody>
                  <?php
                  $i = 1;
                  foreach ($service_providers as $obj) { ?>
                    <tr>
                      ...
                      <td style="display: flex; gap:8px; align-items:center">
                        ...
                        <a class="btn btn-icon avatar-text avatar-md" data-bs-toggle="offcanvas" data-bs-target="#Viewservice<?= $obj['id']; ?>" title="View More">
                          <i class="feather feather-eye"></i>
                        </a>
                        <a class="btn btn-icon avatar-text avatar-md" href="<?php echo base_url(); ?>index.php/Service_providers/print/<?php echo $obj['id']; ?>"><i class="fa fa-print"></i></a>

                        <a class="btn btn-icon avatar-text avatar-md" href="<?php echo base_url(); ?>index.php/Service_providers/edit_service_provider_view/<?php echo $obj['id']; ?>"><i class="feather feather-edit-3"></i></a>
                        ...
                        <a href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#deleteservice<?= $obj['id']; ?>" class="btn btn-icon avatar-text avatar-md">
