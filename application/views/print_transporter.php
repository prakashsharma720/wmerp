                ...
                <div class="row">
                    <div class="col-12">
                      <table class="table">
                        <tbody>
                           <tr>
                            <th colspan="6"> <h4 style="text-align: center">Transporter Personal details : </h4></th>
                          </tr>
                           
                          <tr>
                            <th> Transporter Name : </th>
                            <td> <?= $current['transporter_name'].' ('.$transporter_code.')'?> </td>
                          ...
                          <tr>
                            <th colspan=""> TAN No : </th>
                            <td colspan="4"> <?= $current['tds']?> </td>
                          ...
                          <tr>
                           ...
                           <tr>
                            ...
                            <tr>
                            <th colspan="4"> <h4 style="text-align: center">Transporter Account details : </h4> </th>
                          </tr>
                         <tr>
                            <th>  Bank Name :</th>
