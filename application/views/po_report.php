<div class="nxl-content">
  ...
  <div class="container-fluid" style="position: relative; top:15px;left:15px">
        ...
        <form method="get" id="filterForm">
          ...
          <div class="row">
            ...
            <div class="col-sm-4 col-sm-4   ">
              ...
              <a href="<?php echo $data[0] ?>" class="btn btn-danger  " style="position:relative;width:80px; left:100px; bottom:38px"> Reset</a>
            </div>
          </div>
                      ...
                      <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Purchase_order/deletePO/<?php echo $obj['id']; ?>">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <?php
                            $j = 1;
                            foreach ($obj['po_details'] as $po_detail) { ?>
