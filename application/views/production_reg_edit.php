...
<style type="text/css">
  ...
  <div class="container-fluid">
    <div class="card card-primary card-outline">
      ...
      <div class="card-body">
			<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Production_registers/edit_production">
				...
				<div class="form-group">
		        	<div class="row col-md-12">
		        		<div class="table-responsive">
			        		<table id="maintable">
			        			...
			        			<?php 
			        				if(!empty($production_details)){
			        					$i=1; foreach ($production_details as $key => $pr_detail) { 
			        						//print_r ($pr_detail);
			        						?>
			        					<tr class="main_tr1">
										<td ><?= $i?></td>
			        		...
			        		<input type="hidden" class="total_production_in_mt" name="total_production_in_mt" value="<?= $total_production_in_mt ?>">
			            </div>
		        	</div>
		        </div>
		        	<div class="row col-md-12">
	...
	$( document ).ready(function() {
		...
		function calculate_total(table)
		{
			...
			table.find("tbody tr.main_tr1").each(function()
			{
				...
				$(this).find("td:nth-child(7) input.production_in_mt").val(production_in_mt.toFixed(2));
