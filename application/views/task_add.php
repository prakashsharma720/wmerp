		      		...
		      		<div class="col-md-12">
					        ...
					        <div class="row ">
								...
								<div class="col-md-4">
										...
										<?php  
						               		echo form_dropdown('project', $project,'required="required"') 
						               ?>
						        </div>
								<!--Project -title-->	
								 <div class="col-md-4">
								...
								<!--start date-->	
									<div class="col-md-4 col-sm-4">
						                ...
						                <input type="text" data-date-formate="dd-mm-yyyy" name="start_date" class="form-control date-picker" value="<?php echo $date;?>" placeholder="dd-mm-yyyy"  required>
			            			</div>
								<!--end date-->	
									<div class="col-md-4 col-sm-4">
						            	<label class="control-label">End Date </label> <span class="required">*</span>
						                <input type="text" data-date-formate="dd-mm-yyyy" name="end_date" class="form-control date-picker" value="<?php echo $date;?>" placeholder="dd-mm-yyyy"  required>
			            			</div>

					        	<!--Prioroty-->	
								<div class="col-md-4">
						            	<label class="control-label"> Priority</label><span class="required">*</span>
										<?php  
						               		echo form_dropdown('priority', $priority,'required="required"') 
						               ?>
						        </div>
