		        		...
		        		<div class="table-responsive">
			        		<table id="maintable">
			        			...
			        			<tbody id="mainbody">
			        			 ...
			        			 <tfoot>
			        				<tr>
			        					<td colspan="5" style="text-align: right;"><b> <?= $this->lang->line('total') ?> </b></td>
			        					<td colspan="">
...
<table id="sample_table1" style="display: none;">
	<tbody>
		<tr class="main_tr1">
			...
			<td>
				<input type="text"  placeholder="<?= $this->lang->line('no_of_bags') ?>" name="no_of_bags[]" class="form-control no_of_bags"  autofocus oninput="this.value = this.value.replace(/[^0-9.]/g, '');" style="width:150px;" >
			</td>
			<td>
