											...
											<tr>
												...
												<td>
													...
													<div class="d-flex gap-2">
														<a class="  avatar-text btnEdit" data-toggle="modal" data-target="#view<?php echo $obj['id']; ?>" title=" view details"><i class="fa fa-check"></i></a>
														<a class="avatar-text  btnEdit" href="<?php echo base_url();?>index.php/CustomerSupport_controller/followups/<?php echo $obj['ticket']; ?>" title=" Lead Followup"><i class="fa fa-comment"></i></a>
														<a class="avatar-text btnEdit" href="<?php echo base_url();?>index.php/CustomerSupport_controller/tracking/<?php echo $obj['ticket']; ?>" title=" view details"><i class="fa fa-bullseye"></i></a>
