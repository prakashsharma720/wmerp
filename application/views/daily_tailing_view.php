    ...
    <div class="card-header">
      <!-- <span class="card-title"><?php  echo $title; ?>
       ...
       <div class="button-group float-right">
         ...
         <a href="<?php echo base_url(); ?>index.php/Daily_tailing_records/add" class="btn btn-success" data-toggle="tooltip" title="New Production Register"><i class="fa fa-plus"></i></a>
        ...
        <span class="card-title">Daily Tailing Records           </span>
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          foreach($pr_data as $obj){ ?>
              <tr>
                ...
                <td>
                  <?php 
                         $inv_number=$obj['dtr_code'];
                          if($inv_number<10){
                            $inv_number1='DTR000'.$inv_number;
                            }
                            else if(($inv_number>=10) && ($inv_number<=99)){
                              $inv_number1='DTR00'.$inv_number;
                            }
                            else if(($inv_number>=100) && ($inv_number<=999)){
                              $inv_number1='DTR0'.$inv_number;
                            }
                            else{
                              $inv_number1='DTR'.$inv_number;
                            }
                            echo $inv_number1; ?>
                </td>
                ...
                <td><?php echo $obj['no_of_bags_total']; ?></td>
                <td >
                  ...
                  <a class="btn btn-xs btn-primary btnEdit" href="<?php echo base_url(); ?>index.php/Daily_tailing_records/edit/<?php echo $obj['id'];?>" title="Edit"><i class="fa fa-edit"></i></a>
                ...
                <div class="modal fade" id="view<?php echo $obj['id'];?>" role="dialog">
                    ...
                    <div class="modal fade" id="delete<?php echo $obj['id'];?>" role="dialog">
                      <div class="modal-dialog modal-md">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Daily_tailing_records/deleteDTR/<?php echo $obj['id'];?>">
                        <!-- Modal content-->
                        <div class="modal-content">
                          <div class="modal-header">
  ...
  $( document ).ready(function() {
    ...
    {  
      ...
      if(check == true){  
        ...
        $.ajax({   
          type: "POST",  
          url: "<?php echo base_url(); ?>index.php/Daily_tailing_records/deleteDTR",  
          cache:false,  
