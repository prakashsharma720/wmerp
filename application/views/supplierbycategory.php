     ...
     <div class="col-md-4 col-sm-4 gst_no">
         <label class="control-label"><?=$this ->lang ->line('vendor_service_tax_no')?></label>
         <input type="text" placeholder=" <?=$this ->lang ->line('vendor_service_tax_no')?>" name="vendor_service_tax_no"
     ...
     <div class="col-md-4 col-sm-4 destination">
         ...
         <textarea class="form-control destination1" rows="2" placeholder="<?=$this ->lang->line('enter_destination_here')?>" name="destination"
     ...
     <fieldset class="shipping_details">
         ...
         <div class="row col-md-12 shipping_div">
             ...
             <div class="col-md-4 col-sm-4 saddress1 ">
                 <label class="control-label"> <?=$this ->lang->line('shipping_address1')?> </label>
                     <textarea type="text" placeholder="<?=$this ->lang->line('enter_shipping_address1')?>" name="saddress1" class="form-control saddress1" 
                     value="<?= $customers_data['gst_no']?>" autofocus><?= $customers_data['saddress1']?></textarea>
             </div>
             <div class="col-md-4 col-sm-4  saddress2">
                 <label class="control-label"><?=$this ->lang->line('shipping_address2')?> </label>
                     <textarea type="text" placeholder="<?=$this ->lang->line('enter_shipping_address2')?>" name="saddress2" class="form-control saddress2"
             ...
             <div class="col-md-4 col-sm-4 loc">
                 <label class="control-label"> <?=$this ->lang->line('loc')?></label>
                     <input type="text" placeholder="<?=$this ->lang->line('enter_location')?>" name="loc" class="form-control loc"
     ...
     <div class="row col-md-12">
         <div class="col-md-12 col-sm-12 transporter_div ">
             <label class="control-label"> <?=$this ->lang->line('transport_id')?></label>
