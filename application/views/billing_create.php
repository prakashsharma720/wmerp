...
?>
  ...
  <div class="container-fluid">
    <div class="card card-primary card-outline">
      ...
      <div class="card-body">
			<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Billing/add_new_record">
		        	...
		        	<div class="row col-md-12">
			            ...
			            <div class="col-md-4 col-sm-4 ">
			            	<label  class="control-label"> Suppliers</label>
				            	<?php  
						              echo form_dropdown('supplier_id', $suppliers) 
						          ?>
			            </div>
		        	</div>
		        </div>
			        		...
			        		<table class="table table-bordered " id="maintable" >
			        			...
			        			<tbody id="mainbody">
			        				<tr class="main_tr1">
										...
										<td>
								        <input type="text"  placeholder="Total Amount" name="total_amount[]" class="form-control total_amount"    required='required' readonly="readonly">
										</td>
										<td >
			        			...
			        			<tfoot>
			        				<tr>
			        					...
			        					<td colspan="2" style="text-align: right;">	
			        						<input type="text"  placeholder="Total Amount" name="total_amount_footer" class="form-control total_amount_footer"  readonly ></td>
			        				</tr>
			        				<tr>
			        					...
			        					<td colspan="2">
			        						<input type="text"  placeholder="Taxable Amount" name="texable_amount" class="form-control texable_amount"  value="" readonly >
			        					</td>
			        				</tr>
			        				<tr class="igst_row hide">
			        					<td colspan="2" style="text-align: right;"><b> IGST</b></td>
			        					<td colspan="">
			        						<input type="text"  placeholder=" Enter IGST %" name="tax_per_igst" class="form-control tax_per_igst"  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength="4"  >
			        					</td>
			        					<td colspan="">
			        				...
			        				<tr class="cgst_row">
			        					...
			        					<td colspan="">
			        						<input type="text"  placeholder=" Enter CGST %" name="tax_per_cgst" class="form-control tax_per_cgst"  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength="4"  >
			        					</td>
			        					<td colspan="">
			        				...
			        				<tr class="sgst_row">
			        					...
			        					<td colspan="">
			        						<input type="text"  placeholder=" Enter SGST %" name="tax_per_sgst" class="form-control tax_per_sgst" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength="4"  >
			        					</td>
			        					<td colspan="">
			        				...
			        				<tr>
			        					...
			        					<td colspan="3">
			        						<input type="text"  placeholder=" Grand Total" name="final_total_amount" class="form-control final_total_amount"   readonly >
			        					</td>
			        				</tr>
			        				<tr>
			        					<td colspan="2" style="text-align: right;"><b> ROUND OFF  </b></td>
			        					<td colspan="3">
			        						<input type="text" value="" placeholder=" Round off" name="round_off" class="form-control round_off"   readonly >
			        					</td>
			        				</tr>
			        				<tr>
			        					<td colspan="2" style="text-align: right;"><b> GRAND TOTAL  </b></td>
			        					<td colspan="3">
			        						<input type="text" value="" placeholder=" Grand Total" name="grand_total" class="form-control grand_total"   readonly >
			        					</td>
			        				</tr>
