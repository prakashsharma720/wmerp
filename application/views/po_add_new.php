                        ...
                        <table class="table table-bordered " id="maintable" style="width: 100% !important;">
                            <thead style="background-color: white;">
                                <tr>
                                    ...
                                    <th style="width:10%;wh	ite-space: nowrap;"> Requisition Qty</th>
                            ...
                            <tbody id="mainbody">
                                ...
                                ?>
                                    ...
                                    <tr class="main_tr1">
                                        ...
                                        <td>
                                            <input type="text" placeholder="Qty" name="ordered_qty[]" class="form-control newordered_qty" value="" autofocus required oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                                        </td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('keyup', '.ordered_qty,.newordered_qty,.rate,.discount_value,.tax_per', function() {
            var table = $(this).closest('table');
            calculate_total(table);
        ...
        function calculate_total(table) {
            ...
            table.find(" tbody tr.main_tr1").each(function() {
                ...
                newordered_qty = parseFloat($(this).find("td:nth-child(4) input.newordered_qty").val());
