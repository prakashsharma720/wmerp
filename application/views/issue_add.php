                ...
                <td>
                   <a class="btn btn-xs btn-info " data-toggle="modal" data-target="#view<?php echo $obj['id'];?>" title="View Details" ><i style="color:#fff;"class="fa fa-eye"></i></a>
	                <?php if($obj['approved_status']=='Pending') { ?>
	                  <a class="btn btn-xs btn-primary btnEdit" href="<?php echo base_url(); ?>index.php/Requisition_slips/edit/<?php echo $obj['id'];?>" title="Edit" ><i class="fa fa-edit"></i></a>
	                <?php } ?>

                    <a class="btn btn-xs btn-primary " href="<?php echo base_url(); ?>index.php/Issue_slips/CreateIssueSlip/<?php echo $obj['id'];?>" data-toggle="tooltip" title="Convert to Issue Slip" ><i class="fa fa-refresh"></i> </a>
