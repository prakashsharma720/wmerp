    ...
    <div class="card-header">
      <span class="card-title"><?php  echo $title; ?>
       ...
       <div class="pull-right error_msg">
        <form method="post" action="<?php echo base_url(); ?>index.php/Work_allotments/createXLS">
        ...
        <table id="example2" class="table table-bordered table-striped">
          ...
          $i=1;foreach($requisition_data as $obj){ ?>
            ...
            <tr>
                ...
                <td>
                  <?php 
                         $inv_number=$obj['work_alloted_details'][0]['work_allotment_register_id'];
                          if($inv_number<10){
                            $inv_number1='WA000'.$inv_number;
                            }
                            else if(($inv_number>=10) && ($inv_number<=99)){
                ...
                <td><?php echo $obj['work_alloted_details'][0]['worker_name']; ?></td>
                <td><?php echo $obj['work_alloted_details'][0]['work_allotted']; ?></td>
                <td><?php echo $obj['work_alloted_details'][0]['attendance']; ?></td>
                <td>
                          ...
                          <div class="modal-body">
                              ...
                              <div class="row col-md-12" style="border: 0px solid #f3ecec;
                                  ...
                                  margin-bottom: 6px;">
                                          ...
                                          <div class="col-md-4"><?= $po_detail['worker_name'].' ('.$worker_id_code.')' ;?> </div>
                                          <div class="col-md-4"><?= $po_detail['work_allotted'] ;?> </div>
