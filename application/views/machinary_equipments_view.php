    ...
    <div class="card-header">
      <!-- <span class="card-title"><?php  echo $title; ?>
       ...
       <div class="button-group float-right">
         ...
         <a href="<?php echo base_url(); ?>index.php/Machinary_equipments/add" class="btn btn-success" data-toggle="tooltip" title="New Production Register"><i class="fa fa-plus"></i></a>
        ...
        <span class="card-title">Machinary Equipment          </span>
