	...
	<div class="page-header">
		<div class="page-header-left d-flex align-items-center">
			<div class="page-header-title">
				<h5 class="m-b-10"><?= $this->lang->line('edit_transporter_evaluation_panel') ?></h5>
			</div>
			<ul class="breadcrumb">
...
<div class="main-content">
    ...
    <div class="card-body">
		    		...
		    		<form class="form-horizontal " role="form" method="post" action="<?php echo base_url(); ?>index.php/Evaluation_result/edit_ERT/<?= $id ?>">
		        	...
		        	<div class="row col-md-12">
		        		<div class="col-md-6 col-sm-6 ">
			            	<label class="control-label"><?= $this->lang->line('date') ?> <span class="required">*</span></label>
			                 ...
			                 value="<?php if($date) { echo date('d-m-Y',strtotime($date)); } else echo date('d-m-Y')?>" autofocus required >
			            </div>
