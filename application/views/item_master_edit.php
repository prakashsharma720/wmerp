		      	...
		      	<div class="row">
				   ...
				   <div class="row col-md-12">
					        	 <div class="col-md-6">
						                ...
						                <input type="text"  placeholder="Enter mineral name" name="item_name" class="form-control" value="<?= $item_name?>" required autofocus>
						        </div>
						        <div class="col-md-6">
						            	<label class="control-label"> Grade Name</label>
						                <input type="text"  placeholder="Enter grade name" name="item_code" class="form-control" value="<?= $item_code?>" required autofocus>
						        </div>
					        ...
					        <div class="row col-md-12">
						         ...
						         <div class="col-md-6">
						            	...
						            	<select class="form-control " name="item_description">
											<option value=<?=$unit?> selected><?= $item_description?></option>
												
						            	    <option value=""> Select Packing Type </option>
						            	    <option value="liner"> Liner</option>
						            	    <option value="without liner"> Without Liner</option>			
											</select>
						        </div>
