  ...
  <div class="container-fluid">
    <div class="card card-primary card-outline">
      <div class="card-header">
		...
		<h3 class="card-title"><?= $this->lang->line('product_grid_master'); ?></h3>
					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td> <a class="btn btn-xs btn-info btnEdit" href="<?php echo base_url(); ?>index.php/Grid/index/<?php echo $grid['id'];?>"><i class="fa fa-edit"></i></a></td>
							</tr>
						<?php $i++;} ?>
						</tbody>
