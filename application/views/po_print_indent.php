        ...
        <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
               ...
               <div class="col-sm-4 invoice-col">
                ...
                <h6 style="padding-top: 20px;"> PURCHASE </h6>
                </div>
                <div class="col-sm-4 invoice-col">
                ...
                <div class="row">
                    <div class="col-12">
                      <table class="table">
                        <tbody>
                           <tr>
                            <th colspan="6"> <h4 style="text-align: center">PURCHASE INDENT</h4></th>
                          </tr>
                          <tr>
                            <th rowspan="3" > From :  </th>
                            <td rowspan="3" colspan="2"> <?= $current['0']['supplier']?>,<br> <?= $current['0']['address']?> </td>
                            <th colspan="2"> P.I. Number : </th>
                            <td colspan="2"> 
                                  <?php 
                        ...
                        <tr>
                         <tr>
                          ...
                          <th><label> Quantity (Unit)</label></th>
                          <th>Unit Price (Rs.)</th>
                          <th> Price(Rs.)</th>
                        </tr>
              ...
              <div class="row invoice-info">
                <div class="col-sm-12 invoice-col">
                  <b> Terms and Conditions : </b>
                   <ul>
                     <li>1. Payment Terms</li>
                     <li>2. Delivery Time</li>
                     <li>3. Mention our Purchase Indent No. in your Challan / invoice to avoid delay in payments.</li>
                   </ul>
                </div>
