  ...
  <div class="page-header">
    ...
    <div class="page-header-right ms-auto">
      <div class="page-header-right-items d-flex align-items-center gap-2">
        ...
        <a href="<?php echo base_url(); ?>index.php/Evaluation_result/ev_transporter_add" class="btn btn-icon avatar-text avatar-md" data-toggle="tooltip" title="New Evaluation"><i class="feather feather-plus"></i></a>
                    ...
                    foreach ($er_data as $obj) { ?>
                      <tr>
                        ...
                        <td style="display: flex; gap:8px; align-items:center">
                          ...
                          <a class="btn btn-icon avatar-text avatar-md" data-bs-toggle="offcanvas" data-bs-target="#eva<?= $obj['id']; ?>"><i class="feather feather-eye"></i></a>
                          ...
                          <a class="btn btn-icon avatar-text avatar-md" href="<?php echo base_url(); ?>index.php/Evaluation_result/ev_transporter_edit/<?php echo $obj['id']; ?> "><i class="feather feather-edit-3"></i></a>
