<div class="offcanvas offcanvas-end" tabindex="-1" id="deleteRM<?= $obj['id']; ?>" aria-labelledby="offcanvasLabel<?= $obj['id']; ?>">
  ...
  <div class="offcanvas-body d-flex flex-column" style="padding:1.5rem;">
    ...
    <?php
      $grid_number = $obj['grid_number'] ?? '';
    ?>

    <form method="post" action="<?= base_url(); ?>index.php/Rm_code/deleteRM/<?= $obj['id']; ?>" class="d-flex flex-column h-100">

      <!-- Hidden inputs (optional) -->
      <input type="hidden" name="id" value="<?= $obj['id']; ?>">
      <input type="hidden" name="grid_number" value="<?= $grid_number; ?>">
