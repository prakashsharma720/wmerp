...
<div class="row">
    <div class="col-lg-6 mb-4">
        ...
        <div><span class="fs-12 fw-bold text-default"><?= $obj['account_holder_name'] ?? '-' ?></span></div>
    </div>
...
<div class="row">
    <div class="col-lg-6 mb-4">
        ...
        <div><span class="fs-12 fw-bold text-default"><?= $obj['basic_salary'] ?? '-' ?></span></div>
    </div>
    ...
    <div class="col-lg-6 mb-4">
        ...
        <div><span class="fs-12 fw-bold text-default"><?= $obj['conveyance_allowance'] ?? '-' ?></span></div>
    </div>
     <div class="col-lg-6 mb-4">
        <span class="fw-bold text-dark"><?= $this->lang->line('medical_allowance') ?>:</span>
        <div><span class="fs-12 fw-bold text-default"><?= $obj['medical_allowance'] ?? '-' ?></span></div>
    </div>
     <div class="col-lg-6 mb-4">
        <span class="fw-bold text-dark"><?= $this->lang->line('other_allowance') ?>:</span>
        <div><span class="fs-12 fw-bold text-default"><?= $obj['other_allowance'] ?? '-' ?></span></div>
    </div>
     <div class="col-lg-6 mb-4">
...
<div class="row">
    <div class="col-lg-6 mb-4">
        ...
        <div><span class="fs-12 fw-bold text-default"><?= $obj['emergency_mobile_no'] ?? '-' ?></span></div>
    </div>
    ...
    <div class="col-lg-6 mb-4">
        ...
        <div><span class="fs-12 fw-bold text-default"><?= $obj['uan_no'] ?? '-' ?></span></div>
    </div>

    <div class="col-lg-6 mb-4">
        <span class="fw-bold text-dark"><?= $this->lang->line('pf_no') ?>:</span>
        <div><span class="fs-12 fw-bold text-default"><?= $obj['pf_no'] ?? '-' ?></span></div>
    </div>

    <div class="col-lg-6 mb-4">
        <span class="fw-bold text-dark"><?= $this->lang->line('esi_no') ?>:</span>
        <div><span class="fs-12 fw-bold text-default"><?= $obj['esi_no'] ?? '-' ?></span></div>
    </div>
</div>
