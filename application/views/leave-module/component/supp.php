<div class="offcanvas offcanvas-end" tabindex="-1" id="supp<?= $obj['id']; ?>">
    <!-- Header -->
...
<div class="col-lg-6 mb-3">
    <label class="fw-bold text-dark"><?= $this->lang->line('evaluated_by') ?>:</label>
    <div><?= !empty($obj['created_by']) ? $obj['created_by'] : '-' ?></div>
</div>
