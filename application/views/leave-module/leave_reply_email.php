...
<html>
    ...
    <body >        
        <h1 face="trebuchet ms, sans-serif">Your Leave Application Has been</h1>
        <p face="trebuchet ms, sans-serif">subject: <?= $subject ?></p>
        <p face="trebuchet ms, sans-serif">leave reason: <?= $leave_reason ?></p>
        <p face="trebuchet ms, sans-serif">leave type: <?= $leave_type ?></p>
