            ...
            <div class="form-group">
              <div class="row col-md-12">
                ...
                <div class="col-md-4 col-sm-4 ">
                  ...
                  <?= form_dropdown('supplier_id', $suppliers,$supplier_id) ?>
                </div>
                <div class="col-md-4 col-sm-4 ">
              ...
              <div class="row col-md-12">
                ...
                <div class="col-md-4 col-sm-4 ">
                  ...
                  <input type="text" name="quotation_date" class="form-control date-picker"
                         placeholder="dd-mm-yyyy" autocomplete="off"
                         value="<?php if($transaction_date) { echo date('d-m-Y',strtotime($quotation_date)); } ?>">
                </div>
                <div class="col-md-4 col-sm-4 ">
                    ...
                    <table class="table table-bordered " id="maintable" style="width: 100% !important;">
                      <thead style="background-color: #ca6b24;">
                        <tr>
                          ...
                          <th style="width:15%;white-space: nowrap;"> <?= $this->lang->line('material_description'); ?>
                          </th>
                      ...
                      <tbody id="mainbody">
                        ...
                        ?>
                        <input type="hidden" name="requisition_slip_row_id[]"
                          value="<?= $po_detail['requisition_slip_row_id']?>"> 
                        <tr class="main_tr1">
                          <td><?= $i; ?></td>
                          <td style="width:30%"> 
                          ...
                          <td style="width:15%">
                            <input type="text" name="ordered_qty[]" class="form-control qty" value="<?php echo $po_detail['quantity']; ?>" required>
                          </td>
                          <td style="width:15%">
                            <input type="text" name="pending_qty[]" class="form-control pending_qty" readonly>
                          </td>
                          <td style="width:15%">
                            <input type="text" name="rate[]" class="form-control rate" value="<?php echo $po_detail['rate'] ?>" required>
                          </td>
                          <td style="width:15%">
                            <input type="text" name="total[]" class="form-control total" value="<?php echo $po_detail['amount']; ?>" readonly required>
                          </td>
                          <td style="width:15%">
