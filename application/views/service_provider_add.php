...
<div class="nxl-content">
  <div class="page-header d-flex justify-content-between align-items-center">
    <div class="page-header-left d-flex align-items-center">
      <div class="page-header-title">
        <h5 class="m-b-10"> <?= $this->lang->line('add_new_service_provider') ?></h5>
      </div>
  ...
  <div class="main-content">
    ...
    <label class="control-label">
        <?= $this->lang->line('service_provider_type') ?>
    </label>
    <br>
    <div class="form-check form-check-inline mt-2">
        <input class="form-check-input service_provider_type" type="radio" name="service_provider_type" value="New">
    ...
    <div class="form-check form-check-inline">
        <input class="form-check-input service_provider_type" type="radio" name="service_provider_type" value="Existing" checked>
        <label class="form-check-label">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mt-2">
            ...
            <div class="input-group">
                <select name="prefix" required class="form-select" style="max-width: 80px;">
                    <?php if ($prefix): ?> 
            ...
            <input type="text" 
				 ...
				 <div class="form-group">
		        	<div class="row col-md-12">
		        		...
		        		<div class="col-md-4 col-sm-4 mt-2">
    <label class="control-label">
        <?= $this->lang->line('gst_registration_status') ?>
    </label>
    <br>
    <div class="form-check form-check-inline mt-2">
    ...
    <div class="form-check form-check-inline">
        ...
        <label class="form-check-label">
            <?= $this->lang->line('un_registered_dealer_person') ?>
        </label>
    </div>
</div>
