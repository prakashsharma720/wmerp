							...
							<div class="col-md-4 col-sm-4 ">
				        		<label class="control-label"> <?=$this ->lang ->line('service_provider_type')?> </label>
				        			<div class="form-check">
					               		<input class="form-check-input service_provider_type" type="radio" name="service_provider_type" value="New"  > <?=$this ->lang ->line('new')?></input>
					               		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					               		<input class="form-check-input service_provider_type" type="radio" name="service_provider_type" value="Existing"  checked> <?=$this ->lang ->line('existing')?> </input>
			            		</div>
			            	</div>
		        ...
		        <div class="form-group">
					...
					<div class="col-md-4 col-sm-4">
						...
						<div class="col-md-4 col-sm-4">
			                ...
			                <input type="text" id="firstName" placeholder="<?=$this ->lang ->line('enter_name')?>" name="service_provider_name" class="form-control" value="" autofocus>
			            </div>
			            <div class="col-md-4 col-sm-4">
		        	...
		        	<div class="row col-md-12">
						<div class="col-md-4 col-sm-4">
							...
							<div class="input-group input-group-lg mb-12">
			                    ...
			                    <input type="text" id="firstName" placeholder="<?=$this ->lang ->line('enter_contact_person')?>" name="contact_person" class="form-control" value="" autofocus required>
								</div>
							</div>
					   </div>
					<div class="col-md-4 col-sm-4">
			            	<label  class="control-label"> <?=$this ->lang ->line('email')?></label>
			                <input type="email" id="lastName" placeholder="<?=$this ->lang ->line('enter_email')?>" name="email" class="form-control" value=""  autofocus>
			            </div>
		        		<div class="col-md-4 col-sm-4 ">
								<label class="control-label"> <?=$this ->lang ->line('mobile_no')?> </label>
								<input type="text" placeholder="<?=$this ->lang ->line('enter_mobile')?>" name="mobile_no" class="form-control mobile" minlenght="10" maxlength="10" 
				 ...
				 <div class="form-group">
		        	<div class="row col-md-12">
		        		<div class="col-md-4 col-sm-4 ">
			        		...
			        		<textarea type="text" placeholder="<?=$this ->lang ->line('enter_address')?>" name="address" class="form-control" rows="3" value="" required autofocus style="resize: none;"></textarea>
		        		</div>
		        		 <div class="col-md-4 col-sm-4 ">
						...
						<div class="col-md-4 col-sm-4">
			                ...
			                <input type="text" id="lastName" placeholder="<?=$this ->lang ->line('enter_website')?>" name="website" class="form-control" value="" autofocus>
			            </div>
		        ...
		        <div class="form-group">
		        	<div class="row col-md-12">
			            ...
			            <div class="col-md-4 col-sm-4 ">
			                ...
			                <input type="text"  placeholder="<?=$this ->lang ->line('enter_branch_name')?>" name="branch_name" class="form-control" value="" autofocus required>
			            </div>
			            <div class="col-md-4 col-sm-4 ">
			            	<label class="control-label"> <?=$this ->lang ->line('ifsc_code')?></label>
			                <input type="text" id="firstName" placeholder="<?=$this ->lang ->line('enter_ifsc_code')?>" name="ifsc_code" class="form-control" value="" autofocus required>
			            </div>
		        	</div>
		        </div>
		        <div class="form-group">
		        	<div class="row col-md-12">
		        		 <div class="col-md-4 col-sm-4 ">
			                ...
			                <input type="text" id="firstName" placeholder="<?=$this ->lang ->line('enter_account_no')?>" name="account_no" class="form-control" value="" autofocus required>
			            </div>
