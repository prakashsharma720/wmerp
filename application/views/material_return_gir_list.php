	...
	<form method="get" id="filterForm">
      <div class="row">
          <div class="col-md-4 col-sm-4 ">
            ...
            <div class="col-md-4 col-sm-4 ">
                <label  class="control-label"> <?=$this ->lang ->line('material_return_register_no')?>  <span class="required">*</span></label>
                <select name="gir_no" class="form-control select2 suppliers" >
                    <option value="0"> <?=$this ->lang ->line('select_gir_no')?> r</option>
                    <?php
                         if ($gir_nos): ?> 
                          <?php 
                            foreach ($gir_nos as $value) : ?>
                              <?php 
                                  if ($value['id'] == $id): ?>
                                      <option value="<?= $value['id'] ?>" selected><?= $value['voucher_code'] ?></option>
                                  <?php else: ?>
                                      <option value="<?= $value['id'] ?>"><?= $value['voucher_code'] ?></option>
                                  <?php endif;   ?>
                                   <?php   endforeach;  ?>
                        <?php else: ?>
                            <option value="0"><?=$this ->lang ->line('no_result')?> </option>
              ...
              <tr>
                ...
                <td >
                   <a class="btn btn-xs btn-info btnEdit" data-toggle="modal" data-target="#view<?php echo $obj['id'];?>" title="View GIR Register"><i style="color:#fff;"class="fa fa-eye"></i></a>
				    ...
				    <a class="btn btn-xs btn-success btnEdit" href="<?php echo base_url(); ?>index.php/Gir_registers/print_gen/<?php echo $obj['id'];?>" title="Print GIR Register"><i class="fa fa-print"></i></a>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row col-md-12" style="
                                  ...
                                  margin-bottom: 6px;" >
                              <div class="col-md-6">
                                <label class="control-label"> <?=$this ->lang ->line('material_received_throught')?>  : </label>
                                  <span > 
                                      <?php 
