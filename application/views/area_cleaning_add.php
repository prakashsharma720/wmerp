      ...
      echo $success;
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <?php  //echo $title; exit; ?>
              <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Area_cleaning_records/add_new_record" enctype="multipart/form-data">
                           ...
                           <div class="table-responsive">
            			        		 <table id="maintable" class="table">
            			        			<thead style="background-color: #ca6b24;">
            			        				<tr>
            			        					...
            			        					<th style="white-space: nowrap;width:25%;"> <?= $this->lang->line('area_name') ?> </th>
            			        					<th style="white-space: nowrap;width:10%;"><?= $this->lang->line('frequency') ?></th>
            			        					<th style="white-space: nowrap;width:10%;"> <?= $this->lang->line('status_of_work') ?></th>
                									<th style="white-space: nowrap;width:30%;"> <?= $this->lang->line('select_worker') ?> (Name can be multiple) </th>
                									<th style="white-space: nowrap;width:15%;"> <?= $this->lang->line('remarks') ?> (Additional Comment )</th> 
                                    ...
                                    <?php foreach ($areas as $key=>$value) : ?>
                                      <tr class="main_tr1">
                                       ...
                                       <td >
                                            <?php  echo form_dropdown('worker_id[]', $workers)?>
                                        </td>
                                        <td >
...
<script type="text/javascript">
  $( document ).ready(function() {
    ...
    $("#maintable tbody tr.main_tr1").each(function(){ 
      ...
      $(this).find("td:nth-child(5) select.workers").addClass('select2');
