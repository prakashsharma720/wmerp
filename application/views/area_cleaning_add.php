            			        		 ...
            			        		 <table id="maintable" class="table">
            			        			<thead style="background-color: #ca6b24;">
            			        				<tr>
            			        					...
            			        					<th style="white-space: nowrap;width:25%;"> Area Name </th>
            			        					<th style="white-space: nowrap;width:10%;"> Frequency</th>
            			        					<th style="white-space: nowrap;width:10%;"> Status Of Work</th>
                									<th style="white-space: nowrap;width:30%;"> Select Worker Name (Name can be multiple) </th>
                									<th style="white-space: nowrap;width:15%;"> Remarks (Additional Comment )</th> 
