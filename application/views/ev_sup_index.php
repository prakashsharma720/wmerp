    ...
    <div class="card-header">
      <!-- <span class="card-title"><?=$this ->lang->line('supplier_evaluation_results')?>
       ...
       <div class="button-group float-right">
        ...
        <span class="card-title">Supplier Evaluation Results          </span>
              ...
              <tr>
               ...
               <!--  <td><?php echo $obj['created_by']; ?></td> -->
                <td >
				   ...
				   <a class="btn btn-xs btn-primary btnEdit" href="<?php echo base_url(); ?>index.php/Evaluation_result/ev_supplier_edit/<?php echo $obj['id'];?> "><i class="fa fa-edit"></i></a>
                   <!-- <a target="_blank"href="<?php echo base_url(); ?>index.php/Evaluation_result/pdfFile/<?php echo $obj['id'];?> " class="btn btn-info btnEdit" data-toggle="tooltip" title="Print PDF"><i class="fa fa-file-pdf-o"></i></a> -->
