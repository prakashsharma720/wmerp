	...
	<div class="page-header">
		<div class="page-header-left d-flex align-items-center">
			<div class="page-header-title">
				<h5 class="m-b-10"><?= $this->lang->line('supplier_evaluation_results') ?></h5>
			</div>
			<ul class="breadcrumb">
...
<div class="main-content">
          ...
          <div class="col-md-4 col-sm-4 ">
              ...
              <div class="row">
                 ...
                 <div class="col-md-4 col-sm-4 ">
                  ...
                  <a href="<?php echo $data[0]?>" class="btn btn-danger" style="position:relative;width:80px;left:120px;bottom:38px" ><?= $this->lang->line('reset') ?></a>
              </div>
          </div>
        </form>
     <div class="main-content ">
    ...
    gap: 8px;">
                  ...
                  <a class="btn btn-icon btn-light-brand" href="javascript:void(0);"onclick="deleteEvaluation(<?= $obj['id'] ?>)"> <i class="feather feather-trash"></i></a>
                 ...
                 <?php $this->load->view('leave-module/component/trans.php', ['obj' => $obj]); ?>
                <div class="modal fade" id="view<?php echo $obj['id'];?>" role="dialog">
                    <div class="modal-dialog modal-lg">
                        <!-- Modal content-->
                        <div class="modal-content">
                          <div class="modal-header">
                             <h4 class="modal-title">(<?php echo $obj['supplier_name']?>) <?= $this->lang->line('evaluation_details') ?> </h4>
                    ...
                    <div class="modal fade" id="delete<?php echo $obj['id'];?>" role="dialog">
                      <div class="modal-dialog">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Evaluation_result/deleteERS/<?php echo $obj['id'];?>">
                        <!-- Modal content-->
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-body">
                            <p>Are you sure, you want to delete <b><?php echo $obj['supplier_name'];?> </b> <?= $this->lang->line('evaluation') ?> ? </p>
                          </div>
                          <div class="modal-footer">
...
function deleteEvaluation(id) {
    if (confirm("Are you sure you want to delete this evaluation?")) {
        window.location.href = "<?= base_url('index.php/Evaluation_result/deleteERS/') ?>" + id;
    }
}
</script>
