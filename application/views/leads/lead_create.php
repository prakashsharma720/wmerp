            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" role="form" method="post"
                        ...
                        <?php } else { ?>
                        <form class="form-horizontal" role="form" method="post"
                            action="<?php echo base_url(); ?>index.php/Leads/add_new_item">
                            <?php } ?>
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-4 col-sm-4">
                                    <label class="control-label">Lead Generation Date </label> <span
                                        class="required">*</span>
                                ...
                                <div class="col-md-4">
                                    <label class="control-label"> Contact Person Name <span
                                            class="required">*</span></label>
                                    <input type="text" placeholder="Enter Person Name" name="contact_person"
                                ...
                                <div class="col-md-2 col-sm-2 ">
                                    ...
                                    <?php echo form_dropdown('country', $countrylist, '', 'class="form-control" required="required"'); ?>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" placeholder="Enter Source Name" name="lead_source"
                                        class="form-control" required>
                                </div>
                                ...
                                <div class="row col-md-12">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="control-label">Lead Status</label><span> (Take any action on
                                            lead)</span>
