...
<div class="container-fluid">
    <div class="card card-primary card-outline">
	    ...
	    <div class="card-body">
		    <div class="row">
		      	<div class="col-md-4">
					<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Leads/add_followup" enctype="multipart/form-data">
								...
								<tr>
									...
									<div class="modal fade" id="delete<?php echo $followup['id'];?>" role="dialog">
										<div class="modal-dialog">
											<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Leads/deletefollowup/<?php echo $followup['id'];?>">
												<input type="hidden" name="lead_id" value="<?= $id?>">
