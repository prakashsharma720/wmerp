      ...
      <form method="get">
				<div class="row" id="filter_hide">
					...
					<div class="col-md-4 col-sm-4 ">
					   ...
					   <select name="employee_id" class="form-control select2 " >
						...
						<?php if(!empty($filtered_value['from_date'])) 
							{ 
								$from_date = date('d-m-Y',strtotime($filtered_value['from_date'])); 
							}
							else{ 
								$from_date = date('d-m-Y',strtotime('-7 day')); 
							}

							if(!empty($filtered_value['upto_date'])) 
							{ 
								$upto_date = date('d-m-Y',strtotime($filtered_value['upto_date'])); 
							}
							else{ 
					...
					<div class="col-md-4 col-sm-4">
							...
							<input type="text" value="<?php echo $from_date; ?>" data-date-formate="dd-mm-yyyy" name="from_date" class="form-control date-picker" placeholder="dd-mm-yyyy"  autocomplete="off" autocomplete="off">
					</div>
					<div class="col-md-4 col-sm-4">
							<label  class="control-label"> Upto Date</label>
							<input type="text" value="<?php echo $upto_date; ?>" data-date-formate="dd-mm-yyyy" name="upto_date" class="form-control date-picker" placeholder="dd-mm-yyyy"  autocomplete="off" autocomplete="off">
					</div>
							...
							<td>
								<?php 
									...
									if($obj['is_duplicate']== 0){
										...
										// print_r($leads_id);
										echo "<p style='color:red';>Seems Like  Duplicate  as</p>".$obj['duplicate_lead_code'];
									}
