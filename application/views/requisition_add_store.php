			        		...
			        		<table class="table table-bordered " id="maintable" >
			        			<thead style="background-color: #ca6b24;">
			        				<tr>
			        					...
			        					<th style="width: 15%;"> <?=$this ->lang ->line('bqty')?></th>
			        				...
			        				if(!empty($requisitions)){
			        					...
			        					$total_req_qty=0;
			        					 $i=1; foreach ($requisitions as $key => $po_detail) { 
											...
											<td>
												<input type="text"  placeholder="<?=$this ->lang ->line('enter_qty')?>" name="qty[]" class="form-control qty"  autofocus oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"  value="<?= $po_data['total'] ?>"  required='required'>
											</td>
											<td>
