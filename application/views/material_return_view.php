	...
	<form method="get" id="filterForm">
      <div class="row">
          <div class="col-md-4 col-sm-4 ">
            ...
            <div class="col-md-4 col-sm-4 ">
                <label  class="control-label"> Material Return Register Number <span class="required">*</span></label>
                <select name="voucher_code" class="form-control select2 suppliers" >
        ...
        <table id="example1" class="table table-bordered table-striped">
          <thead>
            <tr>
              ...
              <th style="white-space: nowrap;"> MR No </th>
              <th style="white-space: nowrap;"> GatePass No </th>
          ...
          <tbody>
           ...
           $i=1;foreach($gir_data as $obj){ ?>
              <tr>
                ...
                <td><?php echo $obj['gate_pass_no']; ?></td>
