	...
	<div class="card card-primary card-outline">
		<div class="card-header">
			...
			<div class="pull-right" style="margin-right:5px;">
				<?php if ($role_id !== '3') { ?>
					<a class="btn btn-sm btn-success btnEdit bulk_assign" data-toggle="modal" data-target="#bulk_assign"
						title="Assign Lead"><span style="color:white;font-weight:600;">Assign Lead</span> <i
