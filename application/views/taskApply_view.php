        	...
        	<label> Leave Application : </label><b style="color:#37b5fe;"> <?= $lead_code?></b>
	      	...
	      	<div class="card-body">
		      	<div class="row">
		      		<div class="col-md-12">
		      			<?php if(!empty($id)) { ?>
				    		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Dailytasks/edittask/"<?= $id ?>">
					        ...
					        <div class="row col-md-12">
					        	...
					        	<div class="col-md-4 category_name">
					            	<label class="control-label"> Project Name </label> <span class="required">*</span>
						            	<?php  
						               		echo form_dropdown('employee_id', $categories ,'required="required"') 
						               ?>
						        </div>
					        	 <div class="col-md-4">
						            	<label class="control-label"> Task Name  </label><span class="required">*</span>
						                <input type="text"  placeholder="Enter reason" name="leave_reason" class="form-control" value="" required >
						        </div>
								<div class="col-md-4">
						            	<label class="control-label"> Apply To </label><span class="required">*</span>
										<?php  
						               		echo form_dropdown('leave_type', $leave_types,'required="required"') 
						               ?>
						        </div><div class="col-md-4">
						            	<label class="control-label"> Apply By </label><span class="required">*</span>
										<?php  
						               		echo form_dropdown('leave_type', $leave_types,'required="required"') 
						               ?>
						        </div>
								<!-- <div class="col-md-4">
						            	<label class="control-label"> Subject</label><span class="required">*</span>
						                <input type="text"  placeholder="Enter subject" name="title" class="form-control" value="<?= $title?>" required >
						        </div> -->
								<!-- <div class="col-md-4">
						            	<label class="control-label"> Text</label><span class="required">*</span>
						                <input type="text"  placeholder="Enter text" name="title" class="form-control" value="<?= $title?>" required >
						        </div> -->
						         <!-- <div class="col-md-4">
			                ...
			                <div class="col-md-4">
						        	 ...
						        	 <div class="col-md-4">
						            	<label class="control-label"> Leave Status </label> <span class="required">*</span>
						                <!-- <input type="text"  placeholder="Enter Status" name="lead_source" class="form-control" value="<?= $lead_source?>" required > -->
										  <span> (Take any action)</span>
					                    <select class="form-control" name="leave_status">
					               		   <option value="Pending"> Pending </option>
					               		   <option value="Approved" > Approved </option>
					               		   <option value="In Process">Hold</option>
	...
	$( document ).ready(function() {
		...
		var leave_category = $("input[name='leave_category']:checked").val();
				if(leave_category=='half'){
					$(".half_div").css('visibility', 'visible');
					$(".report_no").attr('required', 'required');
					$(".full_div").css('visibility', 'hidden');
				}
				else {
					$(".half_div").css('visibility', 'hidden');
					$(".full_div").css('visibility', 'visible');
