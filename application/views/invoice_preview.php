    ...
    <div class="card card-primary card-outline">
        <div class="card-header no-print">
            ...
            <div class="pull-right no-print">
                ...
                <!-- <button class="btn btn-primary"><i class="fa fa-edit"></i>
                    <a href="<?php echo base_url(); ?>index.php/Invoice/previewEdit/<?php echo $invoice_data[0]['id']; ?>"
                        style="color:#fff;">&nbsp;Edit Form </a></button> -->
                <!-- </form> -->
            </div>

            <div class="pull-right">
                <form class="form-horizontal" role="form" method="post"
                    action="<?php echo base_url(); ?>index.php/Invoice/form_submit/<?php echo $invoice_data[0]['id']; ?>">
        ...
        <div class="card-body"  style="margin-top:60px;">
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-4 invoice-col" style="padding-top:40px;">
                        <b>ACK No. : </b><?= $invoice_data['0']['ack_no']?><br>
                        <b>ACK Date. : </b><?php  if($invoice_data['0']['ack_date']) echo date('d-m-Y',strtotime($invoice_data['0']['ack_date']))?><br>
                ...
                <div class="row">
                    <div class="col-12 table-responsive">
                        <table class="table table-striped" style="width: 100%;margin-bottom: 0px;">
                            <thead>
                                <tr>
                                    <th style="width:10px;border:1px solid #000;padding:0px;margin:0px;text-align:center;vertical-align: middle;">S.<br>No.</th>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $total_bags = $total_bags+$invoice_details['no_of_bags'];
                                    $total_qty = $total_qty+$invoice_details['quantity'];
                                    
                                    
                                ?>
                                    <tr>
                                        <td style="width:10px;padding:0px;margin:0px;text-align:center;vertical-align: middle;"><b><?= $i;?></b></td>
                                        <td colspan="2" style="padding: 3px;">
                                            <b> <?= $invoice_details['mineral_name']?></b><br>
                                            <b>Grade: <?= $invoice_details['grade_name']?> </b><br>
                                            ...
                                            <?php }?>
                                            <b>HSN Code : <?= $invoice_details['hsn_code']?></b><br>
                                        </td>
                                        ...
                                        <td>
                                            <?php echo number_format($invoice_details['taxable_amount'],2);?>
                                        </td>
                            ...
                            <?php if($invoice_data['0']['frieght_status'] =='Paid' && $invoice_data['0']['delivr_rate'] !='0.00') {?>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <b>HSN Code : <?= $invoice_data['0']['hsncode']?></b><br>
                                    </td>
                                    <!-- <td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"> <b> Add Tax : </b>IGST@ 0.0% <br><b> (Supply to SEZ Unit Under LUT) </b></td>
                                    <td colspan="2">0.00</td>
                                </tr>
                                <?php } ?>
                                <tr>
                                    <td colspan="3" style="text-align:left;"><b>MSME Udyam Reg. No: <br>UDYAM-RJ-33-0000673 </b></td>
                                    ...
                                    <td colspan="2" style="text-align: center;"> <b>
                                            <?php echo number_format($invoice_data['0']['total_tax'],2);?> </b><br>
											   <span style="font-size:14px;">Round Off </span>
                                    </td>
                                    <td style="text-align: left;" >
                                        <b> <?= $invoice_data['0']['total_amount']?></b><br>
										  <?= $invoice_data['0']['round_off']?>
                                    </td>
                                </tr>
                                <tr>
                                <td colspan="6">
                        ...
                        <table class="table" style="width: 100%;">
                            <tbody>
                                <tr>
                                    <td colspan="3" style="width:33%;padding-bottom: 40px;border-top: none;"> <b> <u>Prepared By :</u></b></td>
                                    <td colspan="3" style="width:26%;border-top: none;"> <b> <u>Checked By : </u></b></td>
                                ...
                                <tr>
                                    <td colspan="6" style="width:33%;padding-bottom: 0px;border-top: none;"> <b>
                                        <u>Declaration : </u></b><span style="font-size:13px;" > We declare that this invoice shows the actual price of the goods described and that all particulars are true and correct to the best of our knowledge.</li><br>
