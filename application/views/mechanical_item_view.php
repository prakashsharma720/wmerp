					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td> <a class="btn btn-sm border-0 shadow-none p-1 text-dark" href="<?php echo base_url(); ?>index.php/Mechanical_items/index/<?php echo $mechanical_item['id'];?>"><i class="fa fa-edit"></i></a></td>
							</tr>
						<?php $i++;} ?>
						</tbody>
					</table>
