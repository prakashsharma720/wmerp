		        ...
		        <div class="form-group">
		        	<div class="row col-md-12">
		        		<div class="col-md-4 col-sm-4 ">
			             ...
			             <div class="col-md-4 col-sm-4 ">
			            	<label  class="control-label"><?= $this->lang->line('select_provider_category') ?> <span class="required">*</span></label>
					                ...
					                <?php
					                 if ($categories): ?> 
					                  <?php 
					                    ...
					                    <?php   endforeach;  ?>
					                <?php else: ?>
					                    <option value="0"><?= $this->lang->line('n0_result') ?></option>
					                <?php endif; ?>
					            </select>
			            </div>
			        <div class="col-md-4 col-sm-4 ">
		        ...
		        <div class="row col-md-12">
		        	<div class="col-md-6 col-sm-6 ">
		        	 ...
		        	 <div class="col-md-6 col-sm-6 ">
	            		...
	            		<label> <?= $this->lang->line('below_average') ?>e</label> : 5 
		            </div>
		        </div>
	        	<div class="row col-md-12">
