...
<style type="text/css">
  ...
  <div class="container-fluid">
    <div class="card card-primary card-outline">
      ...
      <div class="card-body">
			<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Waste_material_records/edit_record">
		        	...
		        	<div class="row col-md-12">
			           ...
			           <div class="col-md-4 col-sm-4 ">
			            ...
			            <div class="col-md-4 col-sm-4">
				    		...
				    		<input type="text" class="form-control total_workers" name="total_waste_materials" value="<?= $total_waste_materials?>" readonly="readonly">
			    		</div>
		        	</div>
					<br>
				<div class="form-group">
		        	<div class="row col-md-12">
		        		<h5><?=$this ->lang->line('waste_materials_detail')?></h5>
		        		<div class="table-responsive">
			        		<table id="maintable">
			        			...
			        			<?php 
			        				...
			        				$i=1; foreach ($waste_details as $key => $pr_detail) { 
			        				//print_r ($pr_detail);
			        			?>
			        			<tr class="main_tr1">
									<td ><?= $i ?></td>
                        			<td> 
                        				...
                        				value="<?= $pr_detail['waste_material_name'] ?>" />
                        		                 ...
                        		                 if ($suppliers): ?> 
                        		                  <?php 
                        		                    foreach ($suppliers as $value) : ?>
                        		                      	<?php if ($value['id'] == $pr_detail['service_provider_id']): ?>
                        			...
                        			<td>
                        				<input type="text"  placeholder="Quantity" name="quantity[]" class="form-control quantity" 
                        				maxlength="5" autofocus oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" 
                        				style="width:180px;" value="<?= $pr_detail['quantity'] ?>" >
                        			</td>
                        			<td>
                        		                 ...
                        		                 if ($units): ?> 
                        		                  <?php 
                        		                    foreach ($units as $value) : ?>
                        		                      	<?php if ($value['unit_name'] == $pr_detail['unit']): ?>
			        		...
			        		<!--	<tfoot>
			        				<tr>
			        					<td colspan="3" style="text-align: right;"><b> Total Quantity </b></td>
			        					 <td colspan="">
			        						<input type="text"  placeholder="Total Quantity" name="total_qty" class="form-control total_qty"  value="<?= $total_qty?>" readonly >
			        					</td>  
			        				</tr>
			        			</tfoot>-->
			        		</table>
