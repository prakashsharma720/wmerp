    ...
    <div class="card-header">
      <label class="card-title"><?php  echo $title; ?></label>
       <div class="pull-right error_msg">
        <form method="post" action="<?php echo base_url(); ?>index.php/Packing_materials/createXLS">
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        <table  class="table table-bordered table-striped" >
          ...
          <tbody >
           <?php
          $i=1;foreach($packingmaterials as $obj){ ?>
              <tr>
                <!-- <td><?php echo $i;?></td> -->
                <td><?php echo $obj['name'].$obj['bag_size']; ?></td>
                <td><?php echo $obj['bag_packing']; ?></td>
                <td><?php echo $obj['minimum_inventory_qty']; ?></td>
