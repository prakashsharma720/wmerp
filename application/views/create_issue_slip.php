	...
	<div class="page-header d-flex justify-content-between align-items-center">
		<div class="page-header-left d-flex align-items-center">
			<div class="page-header-title">
				<h5 class="m-b-10"> <?= $this->lang->line('create_issue_slip') ?></h5>
			</div>
		...
		<div class="page-header-right d-flex align-items-center gap-2">
			...
			<span style="background-color: white;margin-top: -20px;"> &nbsp;&nbsp;&nbsp;&nbsp;</span> Stock Un-Available
			...
			<div class="card stretch stretch-full">
				<div class="card-body ">
					<form class="form-horizontal " role="form" method="post" action="<?php echo base_url(); ?>index.php/Issue_slips/add_new_issue">
						...
						<div class="form-group">
							<div class="row col-md-12 ">
								<div class="col-md-4 col-sm-4 ">
									...
									<input type="text" data-date-formate="dd-mm-yyyy" name="requisition_date" class="form-control date-picker" placeholder="dd-mm-yyyy" autocomplete="off" value="<?php if ($requisition_date) {
																																																		echo date('d-m-Y', strtotime($requisition_date));
																																																	} ?>" autofocus required>
								</div>
								<div class="col-md-4 col-sm-4 ">
						...
						<div class="form-group">
							<div class="row col-md-12 bg-white mt-3">
									...
									<table class="table table-bordered " id="maintable">
										...
										<tbody id="mainbody">
											...
											if (!empty($requisition_details)) {
												$i = 1;
												foreach ($requisition_details as $key => $gir_detail) {
													//print_r ($gir_detail);
													$total_req_qty = $total_req_qty + $gir_detail['pending_qty'];
											?>

													<?php if ($gir_detail['stock_in'] <= 0) { ?>
														<tr class="main_tr1" style="background-color: white;color:black;">
														<?php } else { ?>
														<tr class="main_tr1">
														<?php } ?>
