                  ...
                  <div class="form-group">
                    <div class="row ">
                       <div class="col-md-4 col-sm-4 ">
                        ...
                        <div class="col-md-4 col-sm-4 ">
                          <label class="control-label"> <?= $this->lang->line('frequency') ?> <span class="required">*</span></label>
                            <input type="text"  placeholder="<?= $this->lang->line('enter_frequency') ?>" name="frequency" class="form-control " value="Monthly"  required autofocus>
                        </div>
                       <div class="col-md-4 col-sm-4">
                       ...
                       <div class="col-md-4 col-sm-4">
                        ...
                        <div class="col-md-4 col-sm-4 ">
                            <label class="control-label"><?= $this->lang->line('status_of_work') ?></label>
                        ...
                        <div class="col-md-4 col-sm-4 ">
                          <label class="control-label"> <?= $this->lang->line('remark') ?> </label>
                           <textarea class="form-control remark" rows="3" placeholder="<?= $this->lang->line('enter_remark') ?>" name="remark" value="" ></textarea>
                        </div>
                    </div>
                 </div>
