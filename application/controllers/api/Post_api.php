...
Class Post_api extends Restserver\Libraries\REST_Controller  {
...
/*public function index_post() {
    ...
    public function index_post() {
       ...
       $data['enquiries'] = $this->Post_model->MOLeadList();
    ...
    public function save_post() {
        ...
        $result = $this->Post_model->record_insert($data);
        if ($result):
            $this->data['status'] = TRUE;
            $this->data['message'] = 'post successfully submitted';
